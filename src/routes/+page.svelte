...
<div class="flex min-h-screen w-full flex-col gap-2 px-4 py-8 sm:px-8 lg:px-16">
	...
	<div class="grid grid-cols-1 items-start gap-6 sm:grid-cols-[1fr_auto_1fr]">
		...
		<span class="self-center justify-self-center text-sm font-bold text-gray-300">VS</span>
