<script lang="ts">
	...
	import AllySupportToggles from './AllySupportToggles.svelte';
...
<div class="flex flex-col gap-2 rounded-xl border border-gray-800 bg-gray-900 p-3 shadow-sm">
	...
	<AllySupportToggles bind:slot {disabled} />
</div>
